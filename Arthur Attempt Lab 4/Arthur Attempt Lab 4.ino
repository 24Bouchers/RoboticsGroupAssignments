...
void setup() {
  ...
  rightSpeed = SPEED_LOWER;
  leftSpeed = SPEED_LOWER;
...
void checkEncoders() {
  ...
  if (currentMillis - prevMillis >= PERIOD) {
    ...
    Serial.print(Sl);
    Serial.print("|Right: ");
    Serial.print(Sr);//making it negtive for direction 
    */
  }//if
}//check Encoders
...
//left is right and right is left 
  ...
  if ((leftSpeed > SPEED_LOWER)||(rightSpeed < SPEED_LOWER))
    {
      leftSpeed = leftSpeed + SPEED_LOWER;
      rightSpeed = rightSpeed + SPEED_LOWER; 
    }//if
