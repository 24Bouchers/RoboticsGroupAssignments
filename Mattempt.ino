...
void fronterror (float frontScan){
  ...
  const double kp = .8; // Adjust kp for quicker response    .8 
  const double ki = 0.1; // Reduce ki for less integration    .1
  const double kd = 1.2; // Increase kd for faster damping   1.2
